...
export const SHELF_LIFE_RECOMMENDATIONS = {
  ...
  '水果': { '冷藏': 7, '冷冻': 60, '常温': 7 },
  '肉类': { '冷藏': 2, '冷冻': 180, '常温': 1 },
  '乳制品': { '冷藏': 14, '冷冻': 90, '常温': 30 },
  '调料': { '冷藏': 180, '冷冻': 365, '常温': 365 },
  '主食': { '冷藏': 7, '冷冻': 60, '常温': 180 },
  '其他': { '冷藏': 14, '冷冻': 90, '常温': 30 },
}

// 详细食材保鲜表（精确到具体食材名称）
const DETAILED_SHELF_LIFE = {
  // 蔬菜 - 绿叶类
  '白菜': { '冷藏': 5, '冷冻': 90, '常温': 2 },
  '菠菜': { '冷藏': 3, '冷冻': 90, '常温': 1 },
  '生菜': { '冷藏': 3, '冷冻': 60, '常温': 1 },
  ...
  '香菜': { '冷藏': 5, '冷冻': 60, '常温': 2 },
  // 蔬菜 - 根茎类
  '胡萝卜': { '冷藏': 14, '冷冻': 90, '常温': 7 },
  '白萝卜': { '冷藏': 14, '冷冻': 90, '常温': 7 },
  '土豆': { '冷藏': 14, '冷冻': 90, '常温': 30 },
  '红薯': { '冷藏': 14, '冷冻': 90, '常温': 30 },
  '山药': { '冷藏': 14, '冷冻': 90, '常温': 14 },
  '莲藕': { '冷藏': 7, '冷冻': 90, '常温': 3 },
  '洋葱': { '冷藏': 30, '冷冻': 90, '常温': 30 },
  '大蒜': { '冷藏': 30, '冷冻': 90, '常温': 30 },
  '生姜': { '冷藏': 30, '冷冻': 90, '常温': 30 },
  // 蔬菜 - 瓜果类
  '西红柿': { '冷藏': 5, '冷冻': 60, '常温': 5 },
  '番茄': { '冷藏': 5, '冷冻': 60, '常温': 5 },
  '黄瓜': { '冷藏': 5, '冷冻': 60, '常温': 3 },
  ...
  '橙子': { '冷藏': 14, '冷冻': 60, '常温': 7 },
  '橘子': { '冷藏': 10, '冷冻': 60, '常温': 7 },
  '柚子': { '冷藏': 21, '冷冻': 60, '常温': 14 },
  '柠檬': { '冷藏': 21, '冷冻': 60, '常温': 14 },
  '梨': { '冷藏': 7, '冷冻': 60, '常温': 5 },
  '桃': { '冷藏': 5, '冷冻': 60, '常温': 3 },
  '葡萄': { '冷藏': 7, '冷冻': 60, '常温': 3 },
  '草莓': { '冷藏': 3, '冷冻': 60, '常温': 1 },
  '蓝莓': { '冷藏': 7, '冷冻': 60, '常温': 3 },
  '猕猴桃': { '冷藏': 10, '冷冻': 60, '常温': 5 },
  '芒果': { '冷藏': 5, '冷冻': 60, '常温': 3 },
  '菠萝': { '冷藏': 7, '冷冻': 60, '常温': 5 },
  '西瓜': { '冷藏': 5, '冷冻': 60, '常温': 1 },
  '香蕉': { '冷藏': 5, '冷冻': 60, '常温': 5 },
  ...
  '奶油': { '冷藏': 7, '冷冻': 90, '常温': 3 },
  '芝士': { '冷藏': 30, '冷冻': 90, '常温': 7 },
  '鸡蛋': { '冷藏': 35, '冷冻': 90, '常温': 14 },
  '鸭蛋': { '冷藏': 35, '冷冻': 90, '常温': 14 },
  '鹌鹑蛋': { '冷藏': 35, '冷冻': 90, '常温': 14 },
  // 主食
  '米饭': { '冷藏': 3, '冷冻': 60, '常温': 1 },
  '面条': { '冷藏': 3, '冷冻': 60, '常温': 365 },
  '馒头': { '冷藏': 5, '冷冻': 60, '常温': 2 },
  '面包': { '冷藏': 5, '冷冻': 60, '常温': 3 },
  '包子': { '冷藏': 3, '冷冻': 60, '常温': 1 },
  '饺子': { '冷藏': 3, '冷冻': 60, '常温': 1 },
  '汤圆': { '冷藏': 3, '冷冻': 60, '常温': 1 },
  '大米': { '冷藏': 365, '冷冻': 365, '常温': 365 },
  '面粉': { '冷藏': 365, '冷冻': 365, '常温': 365 },
  '玉米': { '冷藏': 5, '冷冻': 60, '常温': 3 },
  '燕麦': { '冷藏': 30, '冷冻': 90, '常温': 180 },
}
...
/**
 * 精确食材保鲜天数查询
 * 优先级：DETAILED_SHELF_LIFE[name] → 模糊匹配 → 分类默认值
 */
export function recommendDaysByName(name, category, storage) {
  if (!name) return recommendDays(category, storage)
  
  // 精确匹配
  const exact = DETAILED_SHELF_LIFE[name]
  if (exact && exact[storage] != null) return exact[storage]
  
  // 模糊匹配
  for (const key in DETAILED_SHELF_LIFE) {
    if (name.includes(key) || key.includes(name)) {
      const val = DETAILED_SHELF_LIFE[key][storage]
      if (val != null) return val
    }
  }
  
  // 分类默认值
  return recommendDays(category, storage)
}
